      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <a 
              href="https://share.google/CRuk5wivrIPi1FhGO" 
              target="_blank" 
        ...
        {/* COPYRIGHT */}
        <div className="border-t border-stone-800 mt-16 pt-8 text-center text-xs text-stone-600 flex flex-col md:flex-row justify-between items-center gap-4">
